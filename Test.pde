...
void drawTestGraph()
{
  DRectUI ui = new DRectUI(new Vector2(10, 10), new Vector2Int(500, 400), "Pressure Graph");
  TextUI boxLable = new TextUI(new Vector2(10, 10), new Vector2(0, 60), "Psi Vs Time", 12, 5);
  GraphUI graph = new GraphUI(new Vector2(10, 10), new Vector2Int(480, 300), new Vector2(10, 80), data, "Time (s)", "PSI");
  ui.addChild(boxLable);
  ui.addChild(graph);
  ui.recall();
}
